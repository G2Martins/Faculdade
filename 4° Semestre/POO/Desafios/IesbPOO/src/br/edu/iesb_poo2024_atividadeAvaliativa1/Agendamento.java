...
import br.edu.iesb_poo2024_atividadeAvaliativa1.exceptions.AgendamentoInvalidoException;
...
public class Agendamento {
    ...
    public Agendamento(int id, Date data, String horario, String objetivoConsulta, String statusAgendamento,
            int idCliente, int idPet, int idVeterinario) throws AgendamentoInvalidoException
    {
    	 if (data.before(new Date())) {
             throw new AgendamentoInvalidoException("Data de agendamento não pode ser no passado.");
         }
         if (horario == null || horario.isEmpty()) {
             throw new AgendamentoInvalidoException("Horário de agendamento não pode ser vazio.");
         }
