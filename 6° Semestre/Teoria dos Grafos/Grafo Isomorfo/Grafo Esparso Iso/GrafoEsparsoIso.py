...
if __name__ == '__main__':
    ...
    G1.adicionar_aresta('E', 'A')

    G2 = GrafoEsparso([1, 2, 3, 4, 5])
    G2.adicionar_aresta(1, 3)
    G2.adicionar_aresta(3, 5)
    G2.adicionar_aresta(5, 2)
    G2.adicionar_aresta(2, 4)
    G2.adicionar_aresta(4, 1)

    G3 = GrafoEsparso(['V1', 'V2', 'V3', 'V4', 'V5'])
    G3.adicionar_aresta('V1', 'V2')
    G3.adicionar_aresta('V1', 'V3')
    G3.adicionar_aresta('V1', 'V4')
    G3.adicionar_aresta('V1', 'V5')
